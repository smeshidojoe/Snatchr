...
_RU = {
    ...
    "Cookies": "Cookies",
    "Authentification (For Restricted Videos)":
        "Аутентификация (для видео с ограничениями)",
    "Browser for cookies": "Браузер для cookies",
    "Format Priority": "Приоритет форматов",
    "Show/Hide and reorder formats": "Показ/скрытие и порядок форматов",
    "Edit": "Изменить",
    "Best Compatibility (H.264)": "Лучшая совместимость (H.264)",
    ...
    "Snatchr lives in the tray": "Snatchr живёт в трее",
